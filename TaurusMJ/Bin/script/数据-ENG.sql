...
BEGIN
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A001','Regular Attendance',0,'Regular',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL)
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A011','Regular Overtime',1,'Overtime',1,'Regular',0,0,0,1,1,1,1)
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A012','Weekend Overtime',1,'Overtime',2,'Weekend',0,0,0,1,1,1,1)
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A013','Holiday Overtime',1,'Overtime',3,'Holiday',0,0,0,1,1,1,1)
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A021','Sick Leave',2,'Leave',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL)
  INSERT INTO KQ_RuleCalc(SortID,SortName,CalcTypeID,CalcTypeName,OvertimeTypeID,OvertimeTypeName,Start,Tune,[Integer],WorkRate,OvertimeRate,LeaveRate,
    AbsenceRate) VALUES('A022','Business Leave',2,'Leave',NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL)
END
GO
...
BEGIN
  ...
  INSERT INTO SY_IDName([Class],[ID],[Name]) VALUES('KQ','CalcHour','Work Hours Calculation')
  ...
  INSERT INTO SY_IDName([Class],[ID],[Name]) VALUES('KQ','NoCard','Cardless')
  ...
  INSERT INTO SY_IDName([Class],[ID],[Name]) VALUES('KQ','RegHrs','Ask for leave')
...
BEGIN
  INSERT INTO SY_Oprt(OprtNo,OprtName,OprtPWD,OprtDesc,OprtIsSys,OprtLastLoginTime) VALUES('ADMIN','System Administrator','038CA14B7DEE0F710FD3B68AC45CFC46','',1,getdate())
END
GO
