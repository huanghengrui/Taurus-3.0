...
DATAEXISTS SELECT * FROM SY_Oprt
  INSERT INTO SY_Oprt(OprtNo,OprtName,OprtPWD,OprtDesc,OprtIsSys,OprtLastLoginTime) VALUES('ADMIN','System administrator','038CA14B7DEE0F710FD3B68AC45CFC46','',1,now())
GO
