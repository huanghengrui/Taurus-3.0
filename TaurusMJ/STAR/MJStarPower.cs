...
namespace Taurus
{
    public partial class frmMJStarPower : frmBaseMDIChildReportTree
    {
        ...
        {
            base.ExecItemAdd();
            frmMJStarPowerAdd frm = new frmMJStarPowerAdd(this.Text, CurrentTool);
        ...
        {
            base.ExecItemEdit();
            frmMJStarPowerEdit frm = new frmMJStarPowerEdit(this.Text, CurrentTool, Report.FieldByName("GUID").AsString);
            if (frm.ShowDialog() == DialogResult.OK) ExecItemRefresh();
        }
        ...
        {
            base.ExecItemTAG1();
            new frmMJStarOprt(this.Text, CurrentTool, null, 3, null).ShowDialog();
            ExecItemRefresh();
        }
        ...
        protected override void ExecItemTAG2()
        {
            ...
            base.ExecItemTAG2();
            new frmMJStarOprt(this.Text, CurrentTool,null,4, GUID).ShowDialog();
        }

        protected override void ExecTreeAfterSelect()
        {
            QuerySQL = Pub.GetSQL(DBCode.DB_000300, new string[] { "620", nodeDepartID, nodeDepartList, ItemFindText.Text.Trim()});
            base.ExecTreeAfterSelect();
        }

        protected override void GetDelSql(int rowIndex, ref List<string> sql)
        {
            string ret = Pub.GetSQL(DBCode.DB_000300, new string[] { "552", Report.FieldByName("MacSN").AsString,
