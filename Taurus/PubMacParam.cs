...
namespace Taurus
{
    public partial class frmPubMacParam : frmBaseDialog
    {
        ...
        public frmPubMacParam(string title, string CurrentTool)
        {
            Title = title;
        ...
        {  
            frmPubMacParamAdd frm = new frmPubMacParamAdd("",this.Text, ItemAdd.Text);
        ...
        private void ItemEdit_Click(object sender, EventArgs e)
        {
            ...
            frmPubMacParamAdd frm = new frmPubMacParamAdd(MacSN, this.Text, ItemEdit.Text);
            if (frm.ShowDialog() == DialogResult.OK) frmPubMacParam_Load(null, null);
        }
        ...
        {
            if (!InitMacList()) return;
            frmPubMacParamAdd frm = new frmPubMacParamAdd(connList, this.Text, ItemMomEdit.Text);
            if (frm.ShowDialog() == DialogResult.OK) frmPubMacParam_Load(null, null);
        }
        ...
        private void ItemMomAdd_Click(object sender, EventArgs e)
        {
            ...
            frmPubMacParamAdd frm = new frmPubMacParamAdd(AddList, this.Text, ItemAdd.Text);
            if (frm.ShowDialog() == DialogResult.OK) frmPubMacParam_Load(null, null);
        }
