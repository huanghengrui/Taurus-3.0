IF NOT EXISTS(SELECT * FROM sysobjects WHERE name='RS_Depart')
...
IF NOT EXISTS(SELECT * FROM sysobjects WHERE name='RS_EmpFingerInfo')
  CREATE TABLE RS_EmpFingerInfo
  (
    FingerFlag tinyint NOT NULL,
    FingerNo bigint NOT NULL,
...
IF NOT EXISTS(SELECT * FROM sysobjects WHERE name='RS_EmpDynamicInfo')
