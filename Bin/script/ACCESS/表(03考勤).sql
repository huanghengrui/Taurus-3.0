...
(
  ...
  CONSTRAINT AK_KQ_KQDataFilter UNIQUE(EmpNo,KQDateTime)
)
GO

CREATE TABLE KQ_KQDataFilterMark
(
  [GUID] varchar(36) NOT NULL,
  EmpNo varchar(20) NOT NULL,
  KQDate datetime NOT NULL,
  ...
  T9 varchar(5) NULL,
  T10 varchar(5) NULL,
  CONSTRAINT PK_KQ_KQDataFilterMark PRIMARY KEY([GUID]),
  CONSTRAINT AK_KQ_KQDataFilterMark UNIQUE(EmpNo,KQDate)
)
GO
