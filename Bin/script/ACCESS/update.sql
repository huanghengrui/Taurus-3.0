...
GO
ALTER TABLE RS_Emp ALTER COLUMN FingerNo float NULL
GO
ALTER TABLE RS_EmpFingerInfo ALTER COLUMN FingerNo float NOT NULL
GO
...
GO
ALTER TABLE KQ_MJData ADD FingerNo long NULL
GO
...
INSERT INTO DI_PsssTime(PassTimeID,PassTimeName,T1S,T1E,T2S,T2E,T3S,T3E,T4S,T4E,T5S,T5E,
                              ...
                              '00:00','00:00','00:00','00:00','00:00','ADMIN',Now())
GO
